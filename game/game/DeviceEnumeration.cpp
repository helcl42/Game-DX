...
// Globals
//-----------------------------------------------------------------------------
DeviceEnumeration* DeviceEnumeration::m_instance = NULL;


DeviceEnumeration* DeviceEnumeration::GetInstance()
{
	if(!m_instance)
		m_instance = new DeviceEnumeration();
	return m_instance;
}
...
{
	return DeviceEnumeration::GetInstance()->SettingsDialogProc( hDlg, uiMsg, wParam, lParam );
}
